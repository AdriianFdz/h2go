...
export const TraceabilityIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      className={className}
      width="1em"
...
export const SubmitArrowIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      className={className}
      width="1em"
  ...
  return (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth="1.5"
        d="M12 8.94V18m5-9.06V18M7 8.94V18m5.447-14.894l7.764 3.908c.944.475.608 1.907-.447 1.907H4.236c-1.055 0-1.391-1.432-.447-1.907l7.764-3.908a1 1 0 0 1 .894 0M19.5 21h-15a1.5 1.5 0 0 1 0-3h15a1.5 1.5 0 0 1 0 3"
      />
    </svg>
  );
};
...
export const TradeIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M6.5 7.5h11m0 0L14 11m3.5-3.5L14 4m3.5 12.5h-11m0 0L10 20m-3.5-3.5L10 13" />
  </svg>
);
...
export const DevToolsIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    width="24"
    height="24"
  ...
  >
    ...
    <path d="m14.908 9.7.132.131c1.022 1.023 1.534 1.534 1.534 2.169s-.512 1.147-1.534 2.17l-.132.13M13.072 8l-2.143 8M9.092 9.7l-.132.131C7.938 10.854 7.427 11.365 7.427 12s.51 1.147 1.533 2.17l.132.13" />
  </svg>
);
